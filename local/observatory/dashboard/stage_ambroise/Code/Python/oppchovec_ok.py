...
INPUT_FILES = {
    ...
    'Opp4_fibre': DATA_DIR / "fibre_corse.csv",  # Taux de déploiement de la fibre
    'Cho1': DATA_DIR / "Cho1_personnes.xlsx",
    'Cho2': DATA_DIR / "Cho2_francais_18plus.xlsx",
...
COLONNES = {
    ...
    'Opp4_fibre': "taux_fibre",  # Taux de déploiement de la fibre
    'Cho1': "Nb_Personnes_Quartiers_Prioritaires",
    'Cho2': "Proportion_Francais_18plus",
...
def calc_opp4(r: float, t: float, f: float) -> float:
    """
    Indicateur Opp4: Accès à Internet, 4G et fibre

    Args:
        r: Couverture Internet (débit > 30Mb/s)
        t: Couverture 4G
        f: Taux de déploiement de la fibre

    Returns:
        Score de connectivité numérique = (r + t + f) / 3
    """
    return (r + t + f) / 3
...
def calc_cho2(d_v: float) -> float:
    """
    Indicateur Cho2: Accès au droit de vote (Proportion de Français 18+)

    Args:
        d_v: Proportion de personnes de nationalité française âgées de 18 ans et plus
             (ayant potentiellement le droit de vote)

    Returns:
        Proportion de Français 18+ (en pourcentage)
    """
    return d_v
