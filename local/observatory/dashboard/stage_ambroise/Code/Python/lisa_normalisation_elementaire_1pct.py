...
def calculer_lisa(gdf, w, variable='OppChoVec_1_10'):
    ...
    gdf['lisa_sig'] = lisa.p_sim < 0.01  # Significatif a 1%
...
def visualiser_resultats(gdf, variable='OppChoVec_1_10'):
    ...
    plt.savefig('lisa_analysis_normalisation_elementaire_1pct.png',
                dpi=300, bbox_inches='tight', facecolor='white')
    print("  Carte sauvegardee: lisa_analysis_normalisation_elementaire_1pct.png")
    ...
    plt.tight_layout()
    plt.savefig('lisa_clusters_normalisation_elementaire_1pct.png',
                dpi=300, bbox_inches='tight', facecolor='white')
    print("  Carte des clusters sauvegardee: lisa_clusters_normalisation_elementaire_1pct.png")

    plt.show()


def exporter_resultats(gdf, nom_fichier='resultats_lisa_normalisation_elementaire_1pct.xlsx'):
...
def exporter_clusters_json(gdf, moran_global, fichier='../WEB/lisa_clusters_1pct.json'):
