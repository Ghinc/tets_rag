"""
Calcul de l'inertie intra-classe pour la Classification Hiérarchique Ascendante 3D
...
def preparer_donnees(data, gdf):
    """Prépare les données pour la CAH 3D"""
...
def calculer_clusters_et_inertie(X):
    """Calcule les clusters et l'inertie intra-classe pour 1 à 10 clusters"""
    print("\n[INFO] Calcul de la CAH 3D et de l'inertie intra-classe...")
...
def exporter_vers_excel(df_inertie, output_path):
    ...
    wb = Workbook()
    ws = wb.active
    ws.title = "Inertie intra-classe 3D"
    ...
    ws['A1'] = "Analyse de l'inertie intra-classe - CAH 3D (Opp, Cho, Vec)"
...
def main():
    print("=" * 80)
    print("  CALCUL DE L'INERTIE INTRA-CLASSE - CAH 3D")
    print("=" * 80)

    # Chemins
    json_path = '../WEB/data_scores_0_10.json'
    geojson_path = '../WEB/Commune_Corse.geojson'
    output_graph = '../OUTPUT/cah_3d_inertie_elbow.png'
    output_excel = '../OUTPUT/cah_3d_inertie.xlsx'
